...
impl Session {
    pub fn new(connection: Arc<Mutex<Connection>>) -> Arc<Mutex<Session>> {
        ...
        let hi = time.wrapping_shr(32) & (u32::MAX as i64);
        let lo = time & (u32::MAX as i64);
...
const fn shuffle64(value: i64, part: i64) -> u64 {
    (value & 0xFF000000FF00i64.wrapping_shr(32).wrapping_shl(8)
        | part.wrapping_shr(24)
        | part.wrapping_shr(8) & 0xFF00
        | part.wrapping_shl(24)) as u64
}
